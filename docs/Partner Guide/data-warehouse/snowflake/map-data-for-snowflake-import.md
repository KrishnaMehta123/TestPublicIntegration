...
| **Date**      | Timestamps such as signup or login date      | `2024-03-18`, `18/03/2024`, `03/18/2024`             | Must match selected date format. For more information, refer to [Supported Date Format](doc:map-data-for-snowflake-import#supported-date-format). |
