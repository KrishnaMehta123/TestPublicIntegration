...
[block:parameters]
{
  "data": {
    ...
    "1-0": "Database",
    "1-1": "Select the Snowflake database from the dropdown. Ensure the database has been integrated with CleverTap. For more information, refer to [Database Details](doc:snowflake-configuration#database-details).",
    "2-0": "Query Type",
