...
* [**Repeat Intervals**](doc:schedule-snowflake-import#repeat-intervals): Configure automated recurring imports at defined intervals (for example, every *N* minutes, hours, or days) to ensure continuous and consistent data synchronization.
