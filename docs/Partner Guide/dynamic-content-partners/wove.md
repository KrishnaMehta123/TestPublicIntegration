...
2. Create and customize a _tag_ for each of your email templates. This tag defines the content block where Wove partner messaging will appear.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ef1eb2030b8a94e8dea48c618531fa0b111921bdd92e46709b2ed83742604639-ChatGPT_Image_Aug_18_2025_11_56_37_AM.png",
        null,
        "Create Tags"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/68336fe238202698b47ec908c2397218fd25eb369a44587626a20d30f898221d-image.png",
        null,
        "Copy to ESP"
      ],
      "align": "center",
...
2. Click **Go to Editor** under the _What_ section and select a Basic Template or Saved Template.
3. Depending on your editor preference, use one of the following methods:
   ...
   - If using the **Drag-and-Drop Editor**:
     ...
     3. In the **Content** panel on the right, paste the HTML Snippet copied in _step 3_ of [Create Element on the Wove Dashboard](doc:wove#create-element-on-the-wove-dashboard) inside the block.

        [block:image]{"images":[{"image":["https://files.readme.io/26e8cc12fc75ff9003bf9f1b143d22bad115dfc80ead5d1c72b1f164fb5c19ef-Screenshot_2025-02-12_at_3.49.49_PM.png","","Drag-and-Drop Editor"],"align":"center","sizing":"65% ","border":true,"caption":"Drag-and-Drop Editor"}]}[/block]
   - If using the **HTML Editor**:
     1. Click **Source** to open the HTML view.
     2. Paste the HTML Snippet copied in _step 3_ of [Create Element on the Wove Dashboard](doc:wove#create-element-on-the-wove-dashboard) inside the `<body>` tag.

   [block:image]{"images":[{"image":["https://files.readme.io/37a44902c1da9d41edf277607e58e15b99d05720175ba4148a2da3a455c9b9e0-Screen_Recording_2025-02-12_at_3.50.35_PM_1.gif","","HTML Editor"],"align":"center","sizing":"65% ","border":true,"caption":"HTML Editor"}]}[/block]
