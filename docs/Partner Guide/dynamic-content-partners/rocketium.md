...
<Image alt="Create New Project" align="center" width="75% " border={true} src="https://files.readme.io/2e9b17ff7db0b74b69be55ebe54523880c6fd480568eb62fa34bb392ff61b3a7-image.png">
  Create New Project
</Image>

2. Click **Save** again, after customizing your template, to finalize it.

<Image alt="Customize template" align="center" width="75% " border={true} src="https://files.readme.io/3a5a305c726cbd3191a302ab899b5bd4a75365a0a160212ce2b767dfb11546b6-image.png">
  Customize template
</Image>
...
4. <Image alt="Copy Link" align="center" className="border" width="75% " border={true} src="https://files.readme.io/e56039dea2cd22838774a6b372a5b281407201743d5af32dd458951ca95fe106-image.png" />
...
5. Paste the URL copied in *Step 4* of [Design Static Creative on Rocketium](doc:rocketium#design-static-creative-on-rocketium).

<Image alt="Paste the URL" align="center" width="75% " border={true} src="https://files.readme.io/a8a44c41a18ad53ecc6ef43e2290a4045acc4015b9e09ec49ac72fba8653bef9-image.png">
  Paste the URL
</Image>
...
4. Paste the Rocketium Image URL, which you copied from *Step 4* of [ Design Static Creative on Rocketium](doc:rocketium#design-static-creative-on-rocketium), in the **Endpoint URL** field.
...
<Image alt="Linked Content configuration" align="center" width="75% " border={true} src="https://files.readme.io/286d3f147b09f8906d49d81beb38f86b207221ccc0ae0c549b7b0a892d1fa755-Screen_Recording_2025-02-27_at_1.51.59_PM_1.gif">
...
3. Configure all the campaign settings and then go to the *What* section:
   ...
   2. Select the *Linked Content* configured under [Configure Linked Content API in CleverTap](doc:rocketium#configure-linked-content-api-in-clevertap) and click **Apply**.

<Image alt="Personalization" align="center" width="75% " border={true} src="https://files.readme.io/a3374c8a1e5bc30a31aa7a3a306e8af5223cd4605cae1af3d3fc8d4c420c545f-2025-05-09_19-59-27_1.gif">
  Personalization
</Image>
...
<Image alt="Create Personalized Message Using Linked Content" align="center" width="75% " border={true} src="https://files.readme.io/b969f8819a9aa43a6fcb6e912fe57a58c7c94ca6acf43efba256cff229449481-image.png">
...
<Image alt="Push Notifications" align="center" width="40% " border={true} src="https://files.readme.io/d121294c838907feaf053f8e8669cc69fa7d6ffa22b36df0a4d61f5e434a4636-image.png">
  Push Notifications
</Image>
