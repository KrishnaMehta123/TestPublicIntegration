...
1. Click **Generate Tags** in the top-right to open the tag _Configuration_ dialog.
2. In the _Configuration_ section:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1b4d869942611e2daea1750027ca3ae15dc749bcbad913d074981e348227ffc5-image.png",
        null,
        "Configuration Tags"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c9d2906fe6d90158dac5731111326a711720b632b9a0929c536d4145d5156c2b-image.png",
        null,
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Copy the generated tag from Reignite to use in CleverTap"
    }
  ]
}
[/block]
...
5. Paste the copied Reignite tag code copied in _step 3_ of [Create Personalized Content in Reignite](doc:reignite#create-personalized-content-in-reignite) inside the `<body>` section in the CleverTap Email editor.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8e8820b3ac0bc0d56e6b0624e74a11c95d22bd5c5ea44622208328a7804bb8ad-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8062bb06097a2022a668cce88ecbe813274d0bf451094392804ee923d32bcdab-image.png",
        null,
        "Test Email"
      ],
      "align": "center",
