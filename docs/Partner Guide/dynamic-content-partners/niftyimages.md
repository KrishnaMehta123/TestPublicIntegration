...
<Image alt="Create New Image" align="center" width="75% " border={true} src="https://files.readme.io/d2af368bce1054a4c79a32a38f08de9e3b5a158fc5284e5872f01dc1f5f125fe-image.png">
  Create New Image
</Image>

For this, we have selected a **Personalized Image** (upload your own image).

<Image alt="Personalized Image" align="center" width="75% " border={true} src="https://files.readme.io/06da0fa8021e2fcfe976c6a85b1be9261898e0c910e5ba1c5485cd4acf8bd0bf-image.png">
  Personalized Image
</Image>
...
<Image alt="Personalization Options" align="center" width="75% " border={true} src="https://files.readme.io/70db4944f85c074523132a58cf0e08ec1c7b2a1d0ebadd1e4930813ef11a669b-2025-03-18_17-59-02_1.gif">
  Personalization Options
</Image>

3. Add *Design Options* and *Advanced Options* to enhance the image by adding:
...
<Image alt="Add Elements" align="center" width="75% " border={true} src="https://files.readme.io/5f246f962553a084299297dde5edc23d6771d79148e638a3b532b00b87da245f-image.png">
  Add Elements
</Image>
...
<Image alt="Generate HTML Code" align="center" width="75% " border={true} src="https://files.readme.io/f7c302a6dcb3c1fad1b75d6958f00b1b76370a2c613a45f1a9ea8b663c6d88e5-2025-03-18_17-59-43_1.gif">
  Generate HTML Code
</Image>
...
<Image alt="Insert the HTML Code Snippet" align="center" width="75% " border={true} src="https://files.readme.io/66c125021595a44bc2ff34a134678a79a4a84181bc4b0754a214199019a14ca6-2025-03-19_12-38-49_1.gif">
  Insert the HTML Code Snippet
</Image>

4. Replace the **MERGE\_TAG** with the appropriate [CleverTap Liquid Tag](doc:personalize-message-all#liquid-tags) for personalization, as shown in the following example:
...
<Image alt="Test Email" align="center" width="75% " border={true} src="https://files.readme.io/40643942f6d9671d91ab2e28c426426ae6b316f784a43af5acc1b9f7e206611f-test_emal.png">
  Test Email
</Image>
...
<Image alt="Custom HTML Templates" align="center" width="75% " border={true} src="https://files.readme.io/eb7051795d9a67136234cacb261189643b8ffa64796169ebf67b455cece26670-Screen_Recording_2025-01-13_at_3.51.09_PM_1.gif">
  Custom HTML Templates
</Image>

5. Replace the **MERGE\_TAG** with the appropriate [CleverTap Liquid tag](doc:personalize-message-all#liquid-tags) for personalization. For example:
   * Use `@Profile - Name | default: "Parth"` or `{{Profile.name | default: "Parth"}}`.

<Image alt="Replace the MERGE_TAG" align="center" width="75% " border={true} src="https://files.readme.io/1d117ffcd644fb335fddbdb32cc82fd62448960d2c370b7faf62d9c9c4ceea81-Screen_Recording_2025-01-13_at_3.52.37_PM_1.gif">
  Replace the MERGE\_TAG
</Image>
...
<Image alt="Send Test" align="center" width="75% " border={true} src="https://files.readme.io/ae0b8e73dd9d461905a3aab5502da0c0811cef48b892983cac3d44b791b58ec0-image.png">
  Send Test
</Image>
