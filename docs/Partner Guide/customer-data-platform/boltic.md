...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/cb7e3928d47e82889cb218e08e3d3d5dff4aa01489e017e066d457f91855ef3b-boltic_step_1_.gif",
        "",
        "Set Up a Trigger"
      ],
      "align": "center",
...
4. **Select the API Action** to send the events or user profiles to CleverTap from Boltic whenever the trigger event occurs. Follow these steps:
   ...
   2. Click **API** for configuration:
      ...
      2. Enter the following _CleverTap API endpoint URL_, where you need to replace <region> with the region of your CleverTap account. To know the region of your account, refer to [API Quick Start Guide](https://developer.clevertap.com/docs/api-quickstart-guide).  
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7fa13b1de6b61af8a238de9f75a0599066559dd417f36c5997a962b336a6d1b0-bolt_api_.gif",
        "",
        "Select the API Action"
      ],
      "align": "center",
      "border": true,
      "caption": "Select API Action"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ec929b2cfeb58893c16e9e7795fa67aa9f21227c1325056b119340409e23bbf6-image.png",
        null,
        "Configure Headers"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d933e5fa2afb27527ee712c9a5bf14c37cb246435aee13c110d0a489e8885826-image.png",
        null,
        "Save API configuration"
      ],
      "align": "center",
      "border": true,
      "caption": "Save API Configuration."
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/41578b61a7a03a6c636d925dd28786cc375ec2cf10b6010b6e08eccbb97580b2-done_boltic.gif",
        "",
        "Test and Publish"
      ],
      "align": "center",
      "border": true,
      "caption": "Test and Publish"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7a904e83231aa09949b3086151c011e6002d7613321b910bcfe15898d5485555-image.png",
        null,
        "Create Stream"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8ef27bf0035e195fb31dfe0d8d00beb76b5977abf395ab871f2db3f21a2f69fa-image.png",
        null,
        "Add Source"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/25ffca6e719736b7ea8099f2dd5b1991caf350833f5ada7c003e8e302eaf7f4b-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7b6a90bfe8f7fc36a7d8b908fee4fa22a308dd382fb32df70e29c7efc0453f5b-Screen_Recording_2025-02-19_at_12.02.45_PM_1.gif",
        "",
        "Add Destination"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/0be998dc0e975bcd3830edc4c3aa681dc2c1f0d2a2739ccb411dd0282e2d6508-image.png",
        null,
        "Stream"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b627ebfe560bb7edb9cbd12359347de3cd62505b8f8daa5ad080364f488760c6-image.png",
        null,
        "Install the stream snippet on your website"
      ],
      "align": "center",
      "border": true,
      "caption": "Install Stream Snippet on your Website"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/2018f054d398b7736290e83aed403b782a8b5cf662a7e4a7ab4064e4347cc52f-image.png",
        null,
        "Stream data"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6d945963834b4cb16e95cb30b30a04ade3ed6a2cf2cc3730d76a6665014a910f-Screen_Recording_2025-02-19_at_12.12.20_PM_1.gif",
        "",
        "Verify data uploaded in CleverTap "
      ],
      "align": "center",
      "border": true,
      "caption": "Verify Data Uploaded in CleverTap "
    }
  ]
}
[/block]
