...
<Image alt="Add CleverTap as a Source on DataChannel" align="center" width="95% " border={true} src="https://files.readme.io/1aae59765891469cd4c260657ca8e8616271c70b17ea2a13b9f53fac98d590a4-image.png">
  Add CleverTap as a Source on DataChannel
</Image>
...
<Image alt="Connect CleverTap as a source" align="center" width="95% " border={true} src="https://files.readme.io/063fc3d08049f1c072dcf87d0faf6381228639e2ac24713a98de1721b4281247-image.png">
...
<Image alt="Connect DataSource" align="center" width="95% " border={true} src="https://files.readme.io/c0c8f8b7d9147c7ff513b9ec5481c2eb74c9f28ff749a441d6e3dd4de4e2ad64-image.png">
  Connect DataSource
</Image>
...
<Image alt="Define Data Sources" align="center" width="95% " border={true} src="https://files.readme.io/bf6407952e653d3789c78c26b0fa1e57074660824aa8e4a8ae02ab859cc1fccf-Screen_Recording_2025-01-07_at_3.46.27_PM_1.gif">
  Define Data Sources
</Image>
...
<Image alt="Report Details Configuration" align="center" width="95% " border={true} src="https://files.readme.io/e1c709d9f4d022f864ec970f07b65a357642e0b27f43234166a776ccfe92465f-image.png">
...
<Image alt="Schedule Data Sync" align="center" width="95% " border={true} src="https://files.readme.io/91aff1bc2a0fd6ef0dc09200a5015ba49e871fda995caa4ab49d27eb8ca714ee-image.png">
  Schedule Data Sync
</Image>
...
<Image alt="Finalize Setup" align="center" width="95% " border={true} src="https://files.readme.io/4bd7cbae70657595fb0dd625366b8d83dcc578850617ff3f662e1b80ec129a6b-Screenshot_2025-01-07_at_4.28.32_PM.png">
  Finalize Setup
</Image>

5. Click **Submit** to finalize the setup and run the data export.
6. Select *Numbers of Runs* to monitor the pipeline and check the status of your pipeline in the dashboard.\
   The statuses include:
   * Running
   * Successful
   * Error (if there are issues)

<Image alt="Monitor the pipeline" align="center" width="95% " border={true} src="https://files.readme.io/a047673546c5bc35b97183fedd7a64caf7291d78ed78e6696ac5927d2e07f92a-image.png">
  Monitor the Pipeline
</Image>

7. Select *Data Preview* to preview the data once the pipeline has successfully run.

<Image alt="Data Preview" align="center" width="95% " border={true} src="https://files.readme.io/58f48d341c6547bd17ad9d0b1429ce790815d4f07f37c45778564a186a751fd9-image.png">
  Data Preview
</Image>
