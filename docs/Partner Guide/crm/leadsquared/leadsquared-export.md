...
2. Search for _CleverTap_ and click **Install**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/33343dd088913851a3134410a5324cded17641062df21da260f920755f288ea4-clevertap-install-20250108-104125.gif",
        "",
        "Install the CleverTap Connector in LeadSquared"
      ],
      "align": "center",
      "sizing": "75% ",
      "border": true,
      "caption": "Install the CleverTap Connector in LeadSquared"
    }
  ]
}
[/block]
...
4. Grant connector access by role or user-level settings:
   - _Based on Role_: Choose roles from the _Specify Roles_ dropdown.
   - _Advanced (User Level)_: Select a user boolean field that controls access.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d7b4ab2fb5138724c7d27cb304404de3c9d88de4b294fdbcb0be461894a70c57-24a530cd-0416-482b-8302-20e0579ec61c.gif",
        "",
        "User-level settings"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d385c2f0ad10c867d563e76efccbd4c67cad433cb958ff394266ff65d289a963-image.png",
        null,
        ""
      ],
      "align": "center",
...
3. Configure _Entity Options_ to define sync behavior:

   - _Capture (Create and Update existing)_
   - _Create only new record_
   - _Update only existing record_
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/f2598854231f75bad51cb0cba8cf3b8b2ac61b61195306fc2346aa0f5419672a-image.png",
        null,
      ...
      "sizing": "75% ",
      "border": true,
      "caption": "Configure Entity Options"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/86da639eb053e49f656ae4b39eb8c3537041f2da30b8a4160b7ee79dca26547d-clevertap-lead-mapping-20250108-112803.gif",
        "",
        "Mapping"
      ],
      "align": "center",
...
7. Go to _More Actions_ > _Enable Sync Job_ to activate data flow.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/bc6f02cbccd70fd6dd4ad81fb92cda36ba03a48ca3c54c632bcd3c4578981ecf-e9ea505e-234f-4074-ace8-ec8d1da41648.gif",
        "",
        "Copy Webhook URL"
      ],
      "align": "center",
...
> 📘 Note
> 
> To view job history, Go to _More Actions_ > _View Logs_.
...
| HTTP Method    | `POST`                                                                                                                                     |
| Endpoint URL   | Paste the URL copied in _step 6_ of [Generate a Webhook URL in LeadSquared](doc:leadsquared-export#generate-a-webhook-url-in-leadsquared). |
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d778ff148e399a594bd0660309ca2510d5b7597019cec978391ba4a78a255042-image.png",
        null,
        "Configure Webhook in CleverTap"
      ],
      "align": "center",
      "sizing": "45% ",
      "border": true,
      "caption": "Configure Webhook in CleverTap"
    }
  ]
}
[/block]
...
2. Under the _What_ section, select the Webhook created in the [Configure Webhook in CleverTap](doc:leadsquared-export#configure-webhook-in-clevertap) section.
