...
1. Go to _Settings_ > _Setup_ > _Linked Content_ in the CleverTap dashboard and click **+ Linked Content**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6989c76f720f6ce907ed933fffaebd3479a3a6ebbed6948162b488de299a415a-image.png",
        null,
      ...
      "sizing": "75% ",
      "border": true,
      "caption": "AutoFill Objects with Response"
    }
  ]
}
[/block]
...
3. Configure all the campaign settings and then go to the _What_ section:
   ...
   2. Select the _Linked Content_ configured under [Configure Linked Content API](doc:yotpo#configure-linked-content-api) and click **Apply**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/654f2c92e549bbae6d27ced23d353aea68dc2e9964400737c16c9c49c139660c-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ca72494929343ce3df7d8c3c3bd483c7926eb26118724a80c0f4a83b47b8695d-image.png",
        null,
        "Push Notifications"
      ],
      "align": "center",
