...
1. Go to _Settings_ > _Channels_ > _Webhook_ from the CleverTap dashboard.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3512408261b3c8b03e266b85a6b08cdbdec380882e591b7740d4ed1e1d85e998-image.png",
        null,
        "LoyaltyLion Dashboard"
      ],
      "align": "center",
      "border": true,
      "caption": "LoyaltyLion Dashboard"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3f0944c4df4ae061158621c5a44ea6f8cfb8c954988546d104c5af0baccb21a5-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4d155692e30ec741fa468077a5e940ab8cd970dfab9a9a2dd4001b9f143e3f19-image.png",
        null,
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Verify the data on LoyaltyLion"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8d9e5da0f498e31fdfcb33a0fb65241075404e7ea61b6f64f3dd3fde475b8be9-image.png",
        null,
      ...
      "sizing": "75% ",
      "border": true,
      "caption": "Test the Linked Content"
    }
  ]
}
[/block]
...
3. Configure all the campaign settings and then go to the _What_ section:
   ...
   2. Select the _Linked Content_ configured under [Configure Linked Content API in CleverTap](doc:loyalty-lion#configure-linked-content-api-in-clevertap) and click **Apply**.

      [block:image]{"images":[{"image":["https://files.readme.io/e24f7ff1a37a0e936b6fd820948b17a598068c15a2fc8d88b4035de1f257bd94-image.png",null,"Personalization"],"align":"center","sizing":"65% ","border":true,"caption":"Personalization"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e479e0d10c081b6a3edbbf5023899bf711640bce35f05cc68aeca3e0ffa7e7d-image.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6e360137cfde9c61d7ca3990aa7bd229bf0a6061a305dd1b76f06dcd2b494cf7-image.png",
        null,
      ...
      "sizing": "65% ",
      "border": true,
      "caption": "Set the Title and Message"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/52e84680c8682ff563fd8c423d2e6c7413be99d860215c240a09b1b4e9e3ae59-image.png",
        null,
        "Push Notifications"
      ],
      "align": "center",
