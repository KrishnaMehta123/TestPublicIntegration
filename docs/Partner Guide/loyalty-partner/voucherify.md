...
- **API URL**: Navigate to _Application Information section >  API endpoint > Project Settings _  to find your API URL on your Voucherify dashboard.
...
6. Click the **Create Integration API Key** button. App ID and App Token will be generated after successful integration.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/0d91c3cedeb0c6f1a6908234a17008c11d3a30643e4a2f5eed310769b75dd523-Voucherify_9.png","","Setup CleverTap Integration on Voucherify Dashboard"],"align":"center","border":true,"caption":"Setup CleverTap Integration on Voucherify Dashboard"}]}[/block]
...
1. Navigate to _Settings > Setup > Linked Content_ and select the **+ Linked Content**. A Linked Content form will appear. 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/c6f6c72eb15175c0e0730881c1e3c0f6aa2649125a55411504c7cd5bbb427662-Voucherify_2.png","","Linked Content Headers on CleverTap"],"align":"center","border":true,"caption":"Linked Content Headers on CleverTap"}]}[/block]
...
- **Parameters Tab:**  A parameter named **customersourceid** will appear.  Enable the **Mark mandatory** checkbox to ensure the customer ID is provided, as it is required to assign a coupon to the customer. 
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/f6d18ce12c759ebc670818efdc0fea675f7b1d8d17b128cd10ec35ea9723dbd3-Voucherify_1.png","","Setup Linked Content on CleverTap - Voucherify"],"align":"center","border":true,"caption":"Setup Linked Content on CleverTap - Voucherify"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/b53b764a4ad11839ab16375c75b4191526763492b3dd40b4b3f56cd9e3a39d47-Voucherify_3.png",
        "",
        "Testing for Response on CleverTap - Voucherify"
      ],
      "align": "center",
      "border": true,
      "caption": "Testing for Response on CleverTap - Voucherify"
    }
  ]
}
[/block]
...
3. Click on **Auto-Fill Objects with Response** to automatically populate objects present in the response. For this example, only the** voucher.code** field will be needed – it contains the published coupon code.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/d209b291b7d39ff257c8bbd7d9b9e6cb3977b3936a5a69cc08eabc9186f9eb7d-Voucherify_4.png","","Auto-Fill Objects with Response on CleverTap - Voucherify"],"align":"center","border":true,"caption":"Auto-Fill Objects with Response on CleverTap - Voucherify"}]}[/block]
...
4. Specify the field to be used as the request parameter for the endpoint and map the properties and values. 
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/b086f217ec399430bf07fba77c269175c1c0d6ad144d1a59e61cded228ba3bf1-Voucherify_5.png","","Personalization Setup in CleverTap Campaigns - Voucherify"],"align":"center","border":true,"caption":"Personalization Setup in CleverTap Campaigns - Voucherify"}]}[/block]
5. Select **Apply**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/312af38868642e02f6f8debd84295d978f36f40a198d847cc0cf918230e2f6db-Voucherify_6.png",
        "",
      ...
      "sizing": "70% ",
      "border": true,
      "caption": "Linked Content in CleverTap Email - Voucherify"
    }
  ]
}
[/block]
...
8. Upon publishing the campaign, messages will be delivered either at the scheduled time or immediately. Each message will be personalized for the recipient and will contain the voucher code allocated to them.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/edeb801976c5d71c9368907083b48d6abde52bb32052c7956adea81dbef06551-Voucherify_7.png","","Personalized Discount Code with CleverTap Email Campaign - Voucherify"],"align":"center","sizing":"70% ","border":true,"caption":"Personalized Discount Code with CleverTap Email Campaign - Voucherify"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4fc7770cb30b9158d5f982dffeb32f261177cb600217170d7a83b23fbb6f0002-Voucherify_10.png",
        "",
        "Linked Content - Voucherify"
      ],
      "align": "center",
      "border": true,
      "caption": "Linked Content - Voucherify"
    }
  ]
}
[/block]
