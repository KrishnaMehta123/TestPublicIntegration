...
2. Configure campaign details as required and proceed to the *What* section.
3. In the *Webhook Content* section, select Content Format as `JSON` and select *Custom Body*.
...
<Image alt="Webhook Content" align="center" width="75% " border={true} src="https://files.readme.io/a21c4b5db73de25ae294727d150fd42b9d258737774e972318f15f3799471f3f-image.png">
  Webhook Content
</Image>

5. Click **Preview & Test**  to verify that the event data is being sent.

   <Image alt="Preview & Test" align="center" width="75% " border={true} src="https://files.readme.io/99d4dcd20baa52ca50d3c814ec50e2d236eb6ae98dc8e1fceda91bd6f39682b9-image.png">
     Preview & Test
   </Image>
6. Once configured correctly, you can see the events reflected in the PostHog dashboard.

<Image alt="PostHog dashboard" align="center" width="75% " border={true} src="https://files.readme.io/1a77104e8689cb3837faee92e6a218e9d012424193714cc22ff50b6ed8c7de2e-image.png">
  PostHog dashboard
</Image>
...
1. Go to the *Campaigns* page, click **+ Campaign**, and select *Webhook*.
2. Configure campaign details as required and proceed to the *What* section.
3. In the *Webhook Content* section, select Content Format as `JSON` and select *Custom Body*.
4. Add the following *Identify API* Payload:
...
<Image alt="PostHog dashboard" align="center" width="75% " border={true} src="https://files.readme.io/ea47c31a1e77215570776ebe86f260c0e950e97e967642eea420a06faee80c92-image.png">
  PostHog dashboard
</Image>
