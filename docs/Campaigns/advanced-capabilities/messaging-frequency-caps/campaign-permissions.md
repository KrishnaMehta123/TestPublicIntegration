...
> 📘 Note
>
> Roles define each user’s default behavior and whether they have permission to override the Global Campaign or Throttle Limits at the campaign level. These permissions cannot be changed by users and are defined by an Admin via *Settings > Roles*. 
>
