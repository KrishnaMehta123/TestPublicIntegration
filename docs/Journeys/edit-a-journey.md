...
- **Partial Editing**  
  Used when you want to make non-structural changes directly to the current version of a _Running_ journey. This includes modifying the following: _What_ section, User distribution in an IntelliNODE journey, and Service Provider. For more information, refer to [Edit What Section](doc:edit-a-journey#option-1-edit-what-section). 
- **Full Editing**  
...
[block:parameters]
{
  "data": {
    ...
    "2-1": "Allowed",
    "2-2": "Allowed",
    "2-3": "The older version can be stopped or moved to the Restricted state when creating a new version. Existing users continue to progress along the older journey. You choose what happens to the older version.",
    "3-0": "**Paused**",
    "3-1": "Allowed",
    "3-2": "Allowed",
    "3-3": "The older version can be stopped or moved to the Restricted state when creating a new version. Existing users continue to progress along the older journey. You choose what happens to the older version.",
    "4-0": "**Completed**",
    "4-1": "Not Allowed",
    "4-2": "Allowed",
    "4-3": "Once you publish a new version, you can:<li>**Force exit from version**, if you want all users to immediately move to the new version.</li><li>** Keep moving in the version** if you want to allow existing users to continue moving through it. The new users who meet the updated entry criteria are routed into the new version of the journey.</li>",
    "5-0": "**Stopped**",
    "5-1": "Not Allowed",
    "5-2": "Allowed",
    ...
    "6-1": "Allowed",
    "6-2": "Allowed",
    "6-3": "Existing users continue to progress along the older journey. You choose what happens to the older version."
  },
  "cols": 4,
  "rows": 7,
  "align": [
