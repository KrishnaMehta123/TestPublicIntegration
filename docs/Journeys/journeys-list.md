...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Displays the current state of the Journey, such as Draft, Scheduled, Running, Paused, Completed, Restricted, and Stopped. For more information, refer to [Journey States](doc:journey-states).
      </td>
    </tr>
