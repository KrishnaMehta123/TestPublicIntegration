...
2. Define the Entry Segment. Here, it will be the Action Node where the *Onboarding Completed* event will be the trigger event. When a user completes onboarding, they immediately enter the journey. Since this is a live trigger, the user proceeds to the next node in real time.
3. Drag and drop the **Conditional Split** node from the *Controllers* section. 
4. Click the Conditional Split node to set up the conditions per your requirements. Here, the 
   ...
   * User Property: `preferred_genre`
   ...
   <Image alt="Set Up Conditional Split Node" align="center" border={true} src="https://files.readme.io/065befe1fc18cd125f35dd168844c2bd3e8ba61333ffe53893f5a3d97fbe85d9-Set_Up_Conditional_Split_Node.gif">
     Set Up Conditional Split Node
   </Image>
...
<Image alt="Create Conditional Split Journey for Movie Streaming App" align="center" border={true} src="https://files.readme.io/414acef6279f741efbe0848bdea8a569f75d8cf85f39878940559a3efbe6d438-Conditional_Split_Movie_Streaming_App.png">
...
<Image alt="Sequential Split by User Properties" align="center" width="45% " border={true} src="https://files.readme.io/906ec81a7f1b98190f18f3fea13b9325c50be7a1cf06b1e5ae40faa11d1f294e-Sequential_Split_By_User_Properties.webp">
...
* Conditional Split Node 2 (connected to the “Scheduled” branch): Evaluates the event property delivery\_slot
...
* **Incomplete Split Criteria**
  ...
  <Image alt="Incomplete Split Criteria Error" align="center" border={true} src="https://files.readme.io/1a6f8d7c0090bc07646007e947af202ab93e1a73a8aac97ea00d8acd3c0d6c12-Incomplete_Split_Condition.gif">
    Incomplete Split Criteria Error
  </Image>
* **Previous Node Modified or Deleted**\
  ...
  <Image alt="Previous Node Deleted" align="center" border={true} src="https://files.readme.io/2c491387a028f6eff91fd2f5a6274f29f7de3fdb07502c05109e5e1d859b8ce2-Conditonal_Split_Node_Uninitialized.gif">
    Previous Node Deleted
  </Image>
