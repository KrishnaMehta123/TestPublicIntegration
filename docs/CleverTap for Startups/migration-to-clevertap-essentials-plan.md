...
This section provides a detailed analysis of changes in the new Essentials Plan compared to the Basic Plan(old), organized into the following three categories: **Features and Add-Ons**, **Pricing**, and **Data Retention Policy**.
...
While the appearance of invoices will remain unchanged, the charges will now align with the Essentials Plan in the updated invoices. The total invoice may increase or decrease based on the MAU tier and selected add-ons.  If you choose the annual billing cycle, it comes with a 30% discount.
...
A. For a seamless transition, customers on quarterly or semi-annual billing cycles must consider switching to monthly or annual billing cycles. Moreover, choosing an annual billing cycle comes with a 30% discount. For more information, refer to the [Pricing](https://docs.clevertap.com/docs/migration-to-clevertap-essentials-plan#pricing) section.
