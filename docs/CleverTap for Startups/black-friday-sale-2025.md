...
excerpt: 'Learn more about CleverTap’s Black Friday Sale 2025: 90% Off for New Customers'
deprecated: false
hidden: true
metadata:
  title: ''
...
### Q: When does the 90% discount start?

A: The discount becomes active immediately after your free trial period ends and remains valid for the first 6 months of your subscription.

### Q: Who is eligible for this offer?

A: The offer is exclusively for new customers who have not previously availed any CleverTap discounts or credits.

### Q: Can existing CleverTap customers benefit from this offer?

A: No, this offer is only for first-time subscribers. Existing customers can explore other programs, such as the [Referral Program](doc:refer-a-friend), for ongoing benefits.