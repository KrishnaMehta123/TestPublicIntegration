...
The _Custom Dashboards_ is a feature in CleverTap that allows you to create and customize your board. CleverTap provides a set of default dashboards, such as the [Today View](doc:today-view), which you can use to analyze user activity in your application. 
  ...
  "images": [
    {
      "image": [
        ...
        "Overview of the Custom Dashboard",
        2370
      ],
      "align": "center",
      "border": true,
      "caption": "Custom Dashboard Overview"
    }
  ]
}
[/block]
...
To access boards on the CleveTap dashboard, navigate to _Boards_ > _All Boards_. The _All boards_ page opens.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5733378-All_Boards.png",
        "List of Boards and Cards",
        2380
      ],
      "align": "center",
      "border": true,
      "caption": "List of Boards and Cards"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/a009618-Create_a_Board.gif",
        "",
        "Creating a Board"
      ],
      "align": "center",
      "border": true,
      "caption": "Creating a Board"
    }
  ]
}
[/block]
...
You can sort the boards by the date on which the board was created and the person who created the board. To sort the boards, click the ![Arrow](https://files.readme.io/ea0d68c-Arrow_icon.png) icon under _Created by_ and _Created on_ columns.
  ...
  "images": [
    {
      "image": [
        ...
        "Sort boards based on date and user who created it",
        2378
      ],
      "align": "center",
      "border": true,
  ...
  "images": [
    {
      "image": [
        ...
        "Search boards using board names or creator email",
        2378
      ],
      "align": "center",
      "border": true,
      "caption": "Search Boards"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Mark a Board as Favorite"
    }
  ]
}
[/block]
...
The message _Board marked as favorite successfully!_ displays at the top of the board page, and the board gets added to the _Favorites_ section on the left navigation.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/6ed3ad1-Mark_as_Favorite.png",
        "View boards marked as favorite",
        2724
      ],
      "align": "center",
      "border": true,
      "caption": "Favorite Boards"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "View cards based on specified date range",
        1188
      ],
      "align": "center",
      "border": true,
      "caption": "View Cards based on Date Range"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Refresh the dashboard to view recent information",
        2370
      ],
      "align": "center",
      "border": true,
      "caption": "Refresh the Dashboard"
    }
  ]
}
[/block]
...
> 🚧 Share Board
> 
> The _Share_ option is only visible to the board's creator.
  ...
  "images": [
    {
      "image": [
        ...
        "Share the board with the selected user",
        560
      ],
      "align": "center",
      "border": true,
...
> 
> [block:image]{"images":[{"image":["https://files.readme.io/8f0e9f4-Share_Board_-_Change_Default_Permission.png","Change default user permission to access the boards",561],"align":"center","border":true,"caption":"User Permissions to Access Boards"}]}[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Edit user permissions to access boards",
        1194
      ],
      "align": "center",
      "border": true,
      "caption": "Edit User Permissions"
    }
  ]
}
[/block]
...
| :-------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <p>Paid Plans (Enterprise/Business)</p> | <ul><li>Each user can create up to 100 boards.</li><li>Users can pin up to 20 cards per board.</li><li>Users can share the board within the organization.</li></ul> |
...
Consider the example where you want the number of users who performed _Charged_ event in the last 30 days. To pin the card for these metrics to the Board:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/895eebe-Pin_a_Card_from_Board.gif",
        "",
        "Pin Event to a Custom Board"
      ],
      "align": "center",
      "border": true,
      "caption": "Pin Event to a Custom Board"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5fb4513-View_Card_on_Board.png",
        "",
        "View Card on a Custom Board"
      ],
      "align": "center",
      "border": true,
      "caption": "View Card on a Custom Board"
    }
  ]
}
[/block]
...
> 📘 Note
> 
> The steps listed below can also be followed to pin any chart that provides the _Pin to board(s)_ option.

To pin a card of the example metrics:

1. Navigate to _Segment_ > _Segments_, from the dashboard.
2. Select a segment.
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Pin a Card on the Board"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "sizing": "smart",
      "border": true,
      "caption": "Pin a Segment to Custom Board "
    }
  ]
}
[/block]
...
3. Rename the required _Funnel Steps _ or _Legends_.
4. Click **Customize**.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/eebe5af-Customize_a_Funnel_Card.gif",
        "",
        "Ellipsis Icon"
      ],
      "align": "center",
      "border": true,
      "caption": "Customize a Funnel Card"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      "image": [
        ...
        "Refresh the card to view most recent data",
        1186
      ],
      "align": "center",
      "border": true,
      "caption": "Refresh the Card to View Recent Data"
    }
  ]
}
[/block]
  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "Move a Card on the Board"
    }
  ]
}
[/block]
