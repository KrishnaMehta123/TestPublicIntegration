  ...
  "images": [
    {
      ...
      "align": "center",
      "border": true,
      "caption": "@ Personalization Editor"
    }
  ]
}
[/block]
...
You can create a campaign for each product added to the cart or use a _constant event property_ to personalize the campaign to each user that did not purchase the item. 
