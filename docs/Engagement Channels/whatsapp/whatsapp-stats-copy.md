...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/31444ad-small-WhatsApp_Stats_Flow_New.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/d8503e4-small-whatsapp_graph_Revenue_performance.png",
        null,
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8188caa-small-whatsapp_campaign_errors.png",
        null,
        "Error Types"
      ],
      "align": "center",
...
> 
> In the case of WhatsApp, CleverTap receives data points (such as Sent, Delivered, Viewed.) from Whatsapp as callbacks. However, WhatsApp does not support callbacks for Clicks. Therefore, the Notification Clicked event cannot be tracked and viewed under the _Overall Stats_ tab.
