...
<Image align="center" alt="Create Custom Preference Center" border={true} caption="Create a Custom Preference Center" src="https://files.readme.io/f663053-Click__Email_Preference_Center.png" />
...
<Image align="center" alt="Add Code for Custom Preference Center" border={true} caption="Add Code for Custom Preference Center" src="https://files.readme.io/f2dab58-Add_Code_for_Custom_Preference.png" />
...
<Image align="center" alt="Save Custom Preference Center" border={true} caption="Save Custom Preference Center" src="https://files.readme.io/a86d262-Save_Preference_Center.png" />
...
<Image align="center" alt="Unpublished Preference Center" border={true} caption="Unpublished Email Preference Center" src="https://files.readme.io/dad40ae-Unpublished_Preference_Center.png" />
...
<Image align="center" alt="Manage Custom Email Preference Center" border={true} caption="Manage Custom Email Preference Center" src="https://files.readme.io/3515281-Manage_Custom_Preference_Center.png" />
...
3. Perform one of the following actions:
   ...
   * **Edit**: Allows you to modify the content and layout of the custom page. When you edit an unpublished custom preference center, you need to save it and then publish it from the _Email Preference Center_. The changes are saved and published when you edit an already published custom preference center. <br />
     <Callout icon="📘" theme="info">
