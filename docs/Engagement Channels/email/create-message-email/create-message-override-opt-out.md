...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/7a94b9f-Control_Group_and_Target_Cap_-_email.png",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/75bdda2-Control_Campaign_Reach.png",
        null,
        "Target Cap"
      ],
      "align": "center",
...
After setting up the content of your campaign in _What_ section, you have the option to send a test email notification to any CleverTap user profile you have marked as a _Test profile_ .  
...
You can also _Do Not Disturb_ (DND) hours during which notifications from this push campaign are prevented from going out, either by discarding them or delaying delivery after DND hours complete, such as 9 PM to 9 AM.
