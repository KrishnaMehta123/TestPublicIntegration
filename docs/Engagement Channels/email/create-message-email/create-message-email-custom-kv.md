...
* **Custom headers**: These are additional key-value pairs that you can define and include in your email headers. CleverTap supports adding these under the *What* section of the campaign. For more information, refer to [Custom Headers](doc:create-message-email-custom-kv#custom-headers).
* **Custom extras**: These are additional key-value pairs that you can define and include along with your email body. CleverTap supports adding these under the *What* section of the campaign. For more information, refer to [Custom Extras](doc:create-message-email-custom-kv#custom-extras).
