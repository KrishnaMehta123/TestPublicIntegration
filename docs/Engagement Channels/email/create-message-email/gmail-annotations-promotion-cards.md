...
[block:parameters]
{
  "data": {
    ...
    "2-2": "Ensure that you use an https (not http) URL. This logo selection only shows in the email preview. To render the logo, you must implement [Brand Indicators for Message Identification (BIMI)](doc:brand-indicators-for-message-identification) standards.",
    "3-0": "Discount offer",
