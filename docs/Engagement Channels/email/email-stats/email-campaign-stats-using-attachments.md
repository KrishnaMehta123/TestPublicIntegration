...
3. Click the campaign to open it. The _Stats_ tab displays the following campaign stats: Sent, Viewed, Clicks, CTR, and Converted users (refer to the image below).
