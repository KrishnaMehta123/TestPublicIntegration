...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c70df865f05856c2a53bc137e131fe0ab60fb9bf2ebb9f6439fba501513819cb-image.png",
        null,
        "Default Elements"
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/5533cc57850f22fb837390faed0082612df60c482e4be8d08cad2a526a0bcb6d-image.png",
        null,
        "Design Container"
      ],
      "align": "center",
...
1. When creating an in-app message campaign, select _Advanced In-App Builder_ from the _Builders_ tab. 
...
2. From the _Font_ list, you can select any available _System Fonts_ or your _Custom Fonts_, which will be applied to all elements with Text in your Campaign. 
