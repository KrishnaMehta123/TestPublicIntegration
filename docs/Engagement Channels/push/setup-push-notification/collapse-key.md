...
<Image title="Collapse Key.png" alt={989} align="center" border={true} src="https://files.readme.io/73ae9f0-Collapse_Key.png">
  Collapse Key
</Image>
...
Push Notification 1 (*general notification*) > Notification 2 (*promo code or coupon*) > Notification 3 (*higher validity offer*).
