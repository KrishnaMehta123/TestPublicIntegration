...
| [Delivery priority](doc:push-editor#notification-delivery-priority) | Controls how quickly the push is delivered. Choose from the following options: *High* or *Maximum*. Selecting *High* ensures faster delivery but may affect the battery. For more information, refer to []().                                                                                                                      | Optional          | All                    |
