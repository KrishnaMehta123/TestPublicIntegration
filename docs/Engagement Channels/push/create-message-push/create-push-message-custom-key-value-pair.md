...
Enter the details. You can use the _@_ personalization or _{{}}_ to add [personalization](https://docs.clevertap.com/docs/personalize-message-all) for your message. Enter the required details to create the message.
