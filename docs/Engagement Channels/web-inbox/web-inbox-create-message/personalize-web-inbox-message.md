...
Type the *@* symbol in the *Title* or *Description* fields to invoke the personalization menu when creating a message. The menu allows you to personalize the messages based on user and event properties.
