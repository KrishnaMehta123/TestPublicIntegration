...
3. From the _Created By_ dropdown, select _System_.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/7614538-System_Segments.png","","Filter System User Segments"],"align":"center","border":true,"caption":"Filter System User Segments"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/46f2bf6-View_System_Segments.png",
        "",
        "View All System User Segments"
      ],
      "align": "center",
      "border": true,
      "caption": "View All System User Segments"
    }
  ]
}
[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/9adfb41-All_Segments.png",
        "",
        "Types of Segments"
      ],
      "align": "center",
      "border": true,
      "caption": "Types of Segments"
    }
  ]
}
[/block]
