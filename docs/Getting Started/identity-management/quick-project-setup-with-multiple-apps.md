...
5a. Set up a notification channel.  You must set a notification channel to send push notifications for Android version O and above. For more information, see [Notification Channel](https://developer.clevertap.com/docs/android#section-push-notifications-for-android-o) 
...
5b. Complete the setup. Check that the events and engagement channels are working. To complete push notification integration and enable advanced settings, go to [mobile push channel](https://developer.clevertap.com/docs/android#section-push-notifications).
...
APIs only support Past behavior campaigns.
