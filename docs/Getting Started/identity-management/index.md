---
title: Identity Management  - Do Not Delete This !!
excerpt: Understand how CleverTap manages user identities.
deprecated: false
hidden: true
metadata:
  title: ''
...
next:
  description: ''
---
Identity management is how CleverTap attributes properties and events performed on your application to a specific user. It defines your users' information on the CleverTap dashboard by providing each user with a unique identifier.
