...
You can handle the identified profiles per your requirements on the CleverTap dashboard. To do so, navigate to *Settings* > *Identity* from the CleverTap dashboard and open the *User Identity* page.  
...
<Image title="Identity_Identity logged in Users.png" alt={884} align="center" className="border" border={true} src="https://files.readme.io/25bc2e0-Identity_Identity_logged_in_Users.png" />
...
<Image title="How Do You Want CleverTap to Handle Identified Profiles.png" alt={932} align="center" className="border" border={true} src="https://files.readme.io/54af1bb-How_Do_You_Want_CleverTap_to_Handle_Identified_Profiles.png" />
...
1. Navigate to *Settings* > *User Identity* from the dashboard.
...
<Image title="Do You Want to Use ADID and IDFA as Device Identifiers.png" alt={766} align="center" className="border" border={true} src="https://files.readme.io/f1e3b52-Do_You_Want_to_Use_ADID_and_IDFA_as_Device_Identifiers.png" />
