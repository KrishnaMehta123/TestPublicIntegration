...
You can assign granular permissions to the users for each component. Define which components are available to the user role. You can specify whether the users must have complete or restricted access to Campaigns and Journeys limits. For more information, refer to [Components of Access](doc:role-based-access-control-advanced-governance-limits#components-of-access).

<Image alt="Provide Component Access" align="center" border={true} src="https://files.readme.io/484a9cfcb3aafd73f9c5cb8afc11e9f00afbf953a081a499aa2c5b033c2faaea-image.png" /> Provide Component Access
> 📘 **Template Locking**
>
...
<Image alt="Engagement Permissions" align="center" border={true} src="https://files.readme.io/ce5d102aeb44f1da36cfb3eb2eb71ec961573a6c01508272f971fc1428618b79-image.png" />  Engagement Permissions
...
Yes. All users have <strong>read or view-only access</strong> to all campaign channels by default. This helps them view multi-channel setups (such as in journeys) even if they can’t edit them. However, they cannot create, edit, clone, or publish campaigns for channels where write access is restricted.
