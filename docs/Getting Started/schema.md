...
[block:parameters]
{
  "data": {
    ...
    "7-0": "Properties",
    "7-1": "Attributes that provide additional context around the event. For more information, refer to [Event Property](doc:events#event-properties)."
  },
  "cols": 2,
  "rows": 8,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "11-2": "No",
    "12-0": "`wzrk_id`",
    "12-1": "Tracks open rate; may be empty or not present.",
    "12-2": "No",
    "13-0": "`wzrk_bp`",
    "13-1": "Displays an image in the notification if the URL is present.",
    "13-2": "Yes",
    "14-0": "`wzrk_sound`",
    "14-1": "Plays the default or custom Android notification sound if present.",
    "14-2": "Yes",
    "15-0": "`nt`",
    "15-1": "Displays the notification title; defaults to app name if absent or empty.",
    "15-2": "Yes",
    "16-0": "`nm`",
    "16-1": "Displays the notification body; ignores the notification if absent or empty.",
    "16-2": "Yes",
    "17-0": "`wzrk_dl`",
    "17-1": "Opens the specified deeplink when the notification is clicked, if present.",
    "17-2": "Yes",
    "18-0": "`wzrk_d`",
    "18-1": "Ignores the notification if this key is present.",
    "18-2": "No",
    "19-0": "`ico`",
    "19-1": "Displays the small notification icon from the specified URL if present and not empty.",
    "19-2": "Yes",
    "20-0": "`wzrk_pivot`",
    "20-1": "Identifies the variant type in A/B testing if present and not empty..",
    "20-2": "Yes",
    "21-0": "`wzrk_rnv`",
    "21-1": "Raises the Push Impressions event if present and not empty.",
    "21-2": "No",
    "22-0": "`wzrk_nms`",
    "22-1": "Displays summary text with the image if present and not empty.",
    "22-2": "Yes",
    "23-0": "`wzrk_st`",
    "23-1": "Displays subtitle text next to the app name if present and not empty.",
    "23-2": "Yes",
    "24-0": "`wzrk_clr`",
    "24-1": "Applies the hex color to the small icon and app name (on Android versions below Pie) if present and not empty.",
    "24-2": "Yes",
    "25-0": "`wzrk_bpds`",
    "25-1": "Indicates the image rendering status with the following values:  \n  \n<ul><li> NO_IMAGE- No image included</li>\n<li>SUCCESS- Image downloaded successfully</li>\n<li> NO_NETWORK- Image included but no network connectivity</li>\n  <li> DOWNLOAD_FAILED- Image download failed due to an external error</li></ul>",
    "25-2": "Yes",
    "26-0": "`wzrk_cid`",
    "26-1": "Refers to the channel ID used for the push notification.",
    "26-2": "Yes",
    "27-0": "`wzrk_mutable_content`",
    "27-1": "Enables rendering of rich push notification via extension class if set to true.",
    "27-2": "Yes",
    "28-0": "`wzrk_bi`",
    "28-1": "Specifies the badge icon to be displayed in the push notification.",
    "28-2": "Yes",
    "29-0": "`wzrk_bc`",
    "29-1": "Specifies the badge count to be shown on the app icon.",
    "29-2": "Yes",
    "30-0": "`Campaign Type`",
    "30-1": "Indicates the campaign’s channel type (for example, Push, Email, SMS).",
    "30-2": "No",
    "31-0": "`wzrk_ttl`",
    "31-1": "Specifies the time to live (TTL) for the notification.",
    "31-2": "Yes",
    "32-0": "`wzrk_ttl_s`",
    "32-1": "Specifies the time to live for the notification in seconds.",
    "32-2": "Yes",
    "33-0": "`wzrk_cts`",
    "33-1": "Records the timestamp when the notification is clicked.",
    "33-2": "No",
    "34-0": "`wzrk_ck`",
    "34-1": "Defines the collapse key (typically a timestamp) for the notification.",
    "34-2": "Yes",
    "35-0": "`wzrk_collapsible`",
    "35-1": "Specifies whether the notification is collapsible.",
    "35-2": "Yes",
    "36-0": "`wzrk_category`",
    "36-1": "Specifies the notification category for APNS (iOS only).",
    "36-2": "Yes",
    "37-0": "`wzrk_interruption_level`",
    "37-1": "Sets the interruption level on APNS (iOS only).",
    "37-2": "No",
    "38-0": "`wzrk_relevance_score`",
    "38-1": "Assigns the relevance score on APNS (iOS only).",
    "38-2": "No"
  },
  "cols": 3,
  "rows": 39,
