...
1. [Plan and Define Use cases](https://docs.clevertap.com/docs/marketer-go-live-checklist#plan-and-define-use-cases)
2. [User Consent and Privacy](https://docs.clevertap.com/docs/marketer-go-live-checklist#user-consent-and-privacy)
3. [Track Event and User Attributes](https://docs.clevertap.com/docs/marketer-go-live-checklist#track-event-and-user-attributes)
4. [Test the Attributes](https://docs.clevertap.com/docs/marketer-go-live-checklist#test-attributes)
5. [Review Results](https://docs.clevertap.com/docs/marketer-go-live-checklist#review-results)
...
1. Do an audit on the app based on the [Audit Checklist](https://developer.clevertap.com/docs/go-live-checklist#section-integrate-and-test). 
...
After the Technical team launches the CleverTap integrated platform on the live production project, measure and run the use cases defined in the [Plan and Define Use Cases](https://docs.clevertap.com/docs/marketer-go-live-checklist#plan-and-define-use-cases) section above.
