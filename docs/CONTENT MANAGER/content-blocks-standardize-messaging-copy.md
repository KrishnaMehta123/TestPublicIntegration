  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        **Note**: Event Personalization for Content Blocks is currently in **Private Beta**. For more information, refer to <Anchor label="Event Personalization" target="_blank" href="https://staging.docs.user.clevertap.net/?isFramePreview=true#using-event-personalization">Event Personalization</Anchor>.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        ...
        **Note**: Reminder personalization for Content Blocks is currently in **Private Beta**. For more information, refer to <Anchor label="Reminder Personalization" target="_blank" href="https://staging.docs.user.clevertap.net/?isFramePreview=true#using-reminder-personalization">Reminder Personalization</Anchor>.
      </td>
    </tr>
